...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    var	tlsOptions = {
    	trustedRoots: [atctlscacert],
    	verify: false
    };
    // be sure to change the http to https when the CA is running TLS enabled
    fabric_ca_client = new Fabric_CA_Client('https://localhost:7054', tlsOptions , 'caATC', crypto_suite);
    ...
    return fabric_ca_client.register({enrollmentID: 'user1', affiliation: '',role: 'client'}, admin_user);
}).then((secret) => {
